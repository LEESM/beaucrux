...
class ItemAdmin(SummernoteModelAdmin):
	list_display = ['item_id','item_active','main1','main2','main3','item_name','item_desc','price','custom_price','get_categories','brand','get_options_name','image0','delivery','detail']
